...
namespace Offsets
{
	constexpr int32 GObjects          = 0x043BAC68;
	constexpr int32 AppendString      = 0x00E2C0D0;
	constexpr int32 GNames            = 0x043A26C0;
	constexpr int32 GWorld            = 0x044F4060;
	constexpr int32 ProcessEvent      = 0x01001F10;
