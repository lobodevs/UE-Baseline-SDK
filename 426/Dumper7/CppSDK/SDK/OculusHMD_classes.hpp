...
static_assert(sizeof(UOculusHMDRuntimeSettings) == 0x000060, "Wrong size on UOculusHMDRuntimeSettings");
...
static_assert(offsetof(UOculusHMDRuntimeSettings, bRequiresSystemKeyboard) == 0x00005D, "Member 'UOculusHMDRuntimeSettings::bRequiresSystemKeyboard' has a wrong offset!");
static_assert(offsetof(UOculusHMDRuntimeSettings, HandTrackingSupport) == 0x00005E, "Member 'UOculusHMDRuntimeSettings::HandTrackingSupport' has a wrong offset!");
