...
{
    FRotator RotationalAcceleration;                                                  // 0x0B00 (size: 0xC)
    FRotator RotationalDeceleration;                                                  // 0x0B0C (size: 0xC)
    FRotator MaxRotationalVelocity;                                                   // 0x0B18 (size: 0xC)
    float MinPitch;                                                                   // 0x0B24 (size: 0x4)
    float MaxPitch;                                                                   // 0x0B28 (size: 0x4)
    float WalkingFriction;                                                            // 0x0B2C (size: 0x4)
    float WalkingSpeed;                                                               // 0x0B30 (size: 0x4)
    float WalkingAcceleration;                                                        // 0x0B34 (size: 0x4)
